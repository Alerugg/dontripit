...
async function main() {
  ...
  await page.screenshot({ path: path.join(OUTPUT_DIR, 'pokemon-desktop-home.png'), fullPage: false })
  ...
  await page.screenshot({ path: path.join(OUTPUT_DIR, 'pokemon-desktop-advanced-open.png'), fullPage: false })
