...
ONEPIECE_FACETS = [
    ...
    {"scope": "card", "key": "block", "label": "Block", "value_type": "enum", "ui_type": "chips", "group_name": "Card", "source_path": "attributes.block", "quick_filter": True, "display_order": 180, "options_json": ["1", "2", "3", "4", "5", "X"]},
    ...
    {"scope": "print", "key": "illustration_type", "label": "Illustration Type", "value_type": "enum", "ui_type": "chips", "group_name": "Collecting", "source_path": "attributes.illustration_type", "multi_value": True, "quick_filter": True, "display_order": 210, "options_json": ["Comic", "Animation", "Original Illustrations", "Other"]},
    ...
    {"scope": "print", "key": "manga", "label": "Manga", "value_type": "boolean", "ui_type": "toggle", "group_name": "Collecting", "source_path": "attributes.is_manga", "quick_filter": True, "display_order": 250},
