...
POKEMON_FACETS = [
    ...
    {"scope": "print", "key": "stamp", "label": "Stamp", "value_type": "enum", "ui_type": "multi_select", "group_name": "Collecting", "source_path": "attributes.stamps", "multi_value": True, "searchable": True, "display_order": 250},
