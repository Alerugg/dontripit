...
def main()->int:
    ...
    conn=psycopg2.connect(url,connect_timeout=30,application_name="dontripit_ygo_ocg_production_proof_v4")
    ...
    out=Path(os.getenv('YGO_OCG_PRODUCTION_PROOF_V4_OUTPUT','/tmp/yugioh-ocg-production-proof-v4.json'))
