...
CERTIFIED={'FLOD':'4627','EXFO':'4634','CIBR':'4640','RATE':'4655'}
...
def main():
 ...
 c=psycopg2.connect(url,connect_timeout=30,application_name='dontripit_ygo_ocg_singletons_v4'); c.set_session(readonly=True,autocommit=False)
 try:
 ...
 Path('/tmp/yugioh-ocg-certified-singletons-v4.json').write_text(json.dumps(payload,ensure_ascii=False,indent=2,sort_keys=True,default=str)+'\n',encoding='utf-8'); print(json.dumps(payload,ensure_ascii=False,indent=2,sort_keys=True,default=str)); return 0
